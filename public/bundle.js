...
var CircleComponent = React.createClass({displayName: 'CircleComponent',
  render: function () {
    ...
    React.DOM.div( {className:"box-view"}, 
      React.DOM.div( {className:"box", style:buildStyles(this.props.circle)} , 
