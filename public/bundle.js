  ...
  render: function () {
    ...
    return (
      React.DOM.div( {className:"box-view"}, 
        React.DOM.div( {className:"box", style:buildStyles(circle)} , 
          circle.content
        )
      )
    );
...
var CirclesComponent = React.createClass({displayName: 'CirclesComponent',
  render: function () {
    var circles = this.props.circles;

    return (
      React.DOM.div( {className:"circles"}, 
